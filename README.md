...
- 방명록 저장 시 javascript의 new Date()함수를 사용하여 작성된 시간을 함께 저장하고, 최신순으로 정렬하여 조회할 수 있도록 하였습니다.
- 입력창을 누를 경우 사용자가 어떤 입력창에 작성중인지 알기 편하게 하기위해 테두리를 강조하였습니다.
